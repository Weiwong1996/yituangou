...
<body>
					...
					<ul class="slides">
						<li data-thumb="${gpic}">
							<div class="thumb-image">
								<img src="${gpic}" data-imagezoom="true" class="img-responsive">
							</div>
						</li>
						<li data-thumb="${gpic1}">
							<div class="thumb-image">
								<img src="${gpic1}" data-imagezoom="true" class="img-responsive">
							</div>
						</li>
						<li data-thumb="${gpic2}">
							<div class="thumb-image">
								<img src="${gpic2}" data-imagezoom="true" class="img-responsive">
							</div>
						</li>
					</ul>
					<div class="clearfix"></div>
			...
			<div class="col-md-4 showcase">
				...
				<div class="shocase-rt-bot">
					<div class="float-qty-chart">
						<ul>
							<li class="qty">
								<h3>尺码</h3> <select class="form-control siz-chrt">
									<option>35</option>
									<option>36</option>
									<option>37</option>
									<option>38</option>
					 			...
					 			<h3>收件地址：</h3>  <select class="form-control siz-chrt">
    	 					<c:forEach var="a" items="${alist}">
								<option >${a.aaddress}  ${a.aname}  ${a.aphone}</font>
							</c:forEach>
							</option> 
	</select>
							</li>
					...
					<ul>
						<li class="ad-2-crt simpleCart_shelfItem"><a
							class="btn item_add" href="IndexServlet?op=addOrder&aid=2&gid=${gid}&uid=${uid}" role="button"><font size=7>立即团购</font></a>
				...
				<div class="showcase-last">
					...
					<ul>
						<li>1、什么是团购?
							...
							专业、直接的导购服务，满足用户足不出户就可以在网上放心购物的需求。</li>
						<li>2、团购购买流程是怎样的？ 在识货团购页面挑选自己喜欢的商品进入对应淘宝店家</li>
		...
		<div class="container">
			...
			<div class="col-md-4 grid-stn simpleCart_shelfItem">
				...
				<div class="ih-item square effect3 bottom_to_top">
					<div class="bottom-2-top">
						<div class="img">
							<img src="img/grid4.jpg" alt="/" class="img-responsive gri-wid">
						</div>
						<div class="info">
			...
			<div class="col-md-4 grid-stn simpleCart_shelfItem">
				...
				<div class="ih-item square effect3 bottom_to_top">
					<div class="bottom-2-top">
						<div class="img">
							<img src="img/grid6.jpg" alt="/" class="img-responsive gri-wid">
						</div>
						<div class="info">
							<div class="pull-left styl-hdn">
								<h3>style 01</h3>
			...
			<div class="col-md-4 grid-stn simpleCart_shelfItem">
				...
				<div class="ih-item square effect3 bottom_to_top">
					<div class="bottom-2-top">
						<div class="img">
							<img src="img/grid3.jpg" alt="/" class="img-responsive gri-wid">
						</div>
						<div class="info">
							<div class="pull-left styl-hdn">
								<h3>style 01</h3>
	...
	<div class="footer-grid">
		<div class="container">
			...
			<div class="col-md-6 re-ft-grd"></div>
