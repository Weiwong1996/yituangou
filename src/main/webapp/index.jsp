							...
							<div class="inner-width">
								<ol>
									...
									<li class="clearfix" id="type_list">
										...
										<div class="t2">
											<a href="IndexServlet?op=byType&type=篮球鞋" class="">篮球鞋<s></s></a> <a href="IndexServlet?op=byType&type=跑鞋" class="">跑鞋<s></s></a>
											<a href="IndexServlet?op=byType&type=休闲鞋" class="">休闲鞋<s></s></a> <a href="IndexServlet?op=byType&type=运动装备" class="">运动装备<s></s></a>
											<a href="IndexServlet?op=byType&type=运动服饰" class="">运动服饰<s></s></a> <a href="IndexServlet?op=byType&type=其它" class="">其它<s></s></a>
										</div>
									</li>
									<li class="clearfix" id="brand_list">
										<div class="t1">品&emsp;&emsp;牌</div>
										<div class="t2">
											<a href="IndexServlet?op=byBrand&type=${gtype}&brand=耐克" class="">耐克<s></s></a> <a href="IndexServlet?op=byBrand&type=${gtype}&brand=AJ" class="">AJ<s></s></a>
											<a href="IndexServlet?op=byBrand&type=${gtype}&brand=阿迪达斯" class="">阿迪达斯<s></s></a> <a href="IndexServlet?op=byBrand&type=${gtype}&brand=三叶草" class="">三叶草<s></s></a>
											<a href="IndexServlet?op=byBrand&type=${gtype}&brand=新百伦" class="">新百伦<s></s></a> <a href="IndexServlet?op=byBrand&type=${gtype}&brand=李宁" class="">李宁<s></s></a>
											<a href="IndexServlet?op=byBrand&type=${gtype}&brand=匡威" class="">匡威<s></s></a> <a href="IndexServlet?op=byBrand&type=${gtype}&brand=其它" class="">其它<s></s></a>
										</div>
									</li>
									<li class="clearfix" >
									<div class="t1">筛&emsp;&emsp;选</div>
										...
										<table>
										<tr>
											<td><a href="IndexServlet?op=allGoods">默认</a></td>
											<td><a href="IndexServlet?op=price">价格</a></td>
											<td><a href="IndexServlet?op=discount">折扣</a></td>
										</tr>
										</table>
										</div>
									</li>
				...
				<c:forEach var="g" items="${glist}">
					<div class="goods_items">
						...
						<div class="goods_price">
							...
							<a href="IndexServlet?op=buy&gpic=${g.gpicpath}&gname=${g.gname}&gprice=${g.gnowprice}&gbrand=${g.gbrand}" class="t1">立即抢购</a>
